...
public class Signal extends Element {
	...
	public Signal(String id, String boardId, String number, List<Aspect> aspects, Aspect initialAspect) {
		this.id = id;
	...
	public String dumpYaml(String indent) {
		...
		builder.append(indent).append("  number: ").append(number).append(Util.LINE_BREAK);
