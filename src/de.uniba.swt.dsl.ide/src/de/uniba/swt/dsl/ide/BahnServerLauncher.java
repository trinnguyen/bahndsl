...
public class BahnServerLauncher {
    ...
    public static void main(String[] args) throws IOException, ExecutionException {
        BahnServerLauncher thiz = Guice.createInjector(new ServerModule()).getInstance(BahnServerLauncher.class);
        thiz.start(args);
    }
    ...
    /**
     * create default LSP server
     * sample code for vscode extension
     *
     * @param prefix
     * @param args
     * @return
