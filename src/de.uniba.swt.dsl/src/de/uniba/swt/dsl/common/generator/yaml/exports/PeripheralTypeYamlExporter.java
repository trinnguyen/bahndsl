...
import de.uniba.swt.dsl.bahn.PeripheralType;
...
class PeripheralTypeYamlExporter extends AbstractElementYamlExporter<PeripheralType> {

    @Override
    protected String getId(PeripheralType element) {
        return element.getName();
    }

    @Override
    protected List<Tuple<String, Object>> getProps(PeripheralType element) {
